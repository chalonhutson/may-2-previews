...
class LinkedList(object):
    ...
    def length(self):
        """
        Chalon -->> This method we created as part of Part Three of the Linked Lists in Python section of the assignment.
        """
        current = self.head
        counter = 0
...
def shorten_word(list):
    """
    Chalon -->> This function is what Part Two of the Linked Lists in Python section of the assignment asks for.
    """
    ll = LinkedList()
    for word in list:
        ll.append(word)
